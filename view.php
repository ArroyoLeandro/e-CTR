        ...
        <div class="col-sm-12 col-md-7">
          ...
          <div id="videos-container"></div>
            ...
            <div class="panel-footer controls" style="text-align: center;">
              ...
              <button id="ayuda-comentarios" class="fa fa-question-circle fa-2x" disabled title="Ayuda y Comentarios"></button>
            </div>
                ...
                <div class="panel-body">
                    <div class="user-activity">                        
                        <p class="message">
                            ...
                            Hemos diseñado un espacio dedicado a explicarte cómo funciona <span style="color:#337ab7;italic;font-weight:bold;">e-Chat UNAD</span>, puedas identificar todas las funcionalidades y el potencial que tiene para la comunicación en tiempo real en donde podrás enviar mensajes de texto, iniciar videollamadas y llamadas de voz, compartir imágenes, archivos, emoticones, realizar conversaciones con traducción en tiempo real a tu lenguaje nativo y mucho más. <span role="button" class="fa fa-question-circle fa-1x btn btn-primary btn-sm" id="como-funciona" title="Enseñame Cómo funciona!"> Ayuda y comentarios</span>
                        </p>
                    </div>
                </div> <!-- END panel-body-->
            </div> <!-- END panel panel-primary-->
