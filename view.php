...
//$grupo = 'grupo';
//$link = '<a href="'.$CFG->wwwroot."/mod/ectr/view.php?id=$cm->id".'&group='.$currentgroup.'">'.$grupo.'</a>';
//echo $link;
...
echo '    
        <div class="settings-panel">
            ...
            <label for="autoTranslateText" title="Click to chat with users from different locales! All incoming text messages will be auto converted in your language!">Traducir texto automaticamente a</label>
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" id="chunk-size" value="15000" title="Chrome sending limit is 64000 however Firefox receiving limit is 16000."> <small>chars</small> <br />
                        <label for="chunk-interval" class="adjust-width">Chunk Interval</label>
                        <input type="text" id="chunk-interval" value="100" title="There must be an interval from 50ms to 500ms to make sure data isnt seamlessly skipped."><small>milliseconds</small><br /><br />
        ...
        <div class="main">
            <div class="new-message" style="overflow: hidden;height: 250px;">
                <div class="user-info" style="height: 100%">
                    <img src="pix/foto-perfil.jpg">
                </div>
                <div class="user-activity">                        
                    <h2 class="header">Bienvenido a e-Chat UNAD!</h2>
                    <p class="message">
                        Un espacio diseñado para la comunicación e interacción en tiempo real por medio de <span style="color:#337ab7;italic;font-weight:bold;">mensajes, video llamadas y llamadas de voz</span> entre los integrantes del grupo.<br /><br />
                        Hemos diseñado un espacio dedicado a explicarte cómo funciona <span style="color:#337ab7;italic;font-weight:bold;">e-Chat UNAD</span>, puedas identificar todas las funcionalidades y el potencial que tiene para la comunicación en tiempo real en donde podrás compartir mensajes, video, audio, imágenes, archivos con vista previa, emoticones y mucho más. <button class="fa fa-question-circle fa-1x" id="como-funciona" title="Enseñame Cómo funciona!"> Ayuda y comentarios!</button>
                    </p>
                </div>
            </div>
        </div>
